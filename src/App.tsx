...
export default function App() {
  ...
  const { revoke, batchRevoke, contractBatchRevoke } = useRevoke();
  ...
  const handleRevokeSelected = useCallback(async () => {
    ...
    const revokeEntries = toRevoke.map((e) => ({
      id: e.id,
      ...
      <main className="flex-1 max-w-5xl mx-auto w-full px-4 sm:px-6 py-8 space-y-6">
        ...
        {activePage === 'shield' ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            <div className="h-20 w-20 rounded-2xl bg-brand-500 flex items-center justify-center mb-6">
